...
def hammerf(request):
    ...
    xx = os.path.join(workpath, 'nifty_500.xlsx') #yaha tak
    ...
    dictt = {'zips': zipp ,'candle' : 'Hammer' , 'number':num, 'paras': para , 'signals': signal}
...
def dragonfly_dojif(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Dragonfly Doji' , 'number':num, 'signals':signal}
...
def white_marubozuf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'White Marubozu' , 'number':num, 'signals':signal}
...
def bullish_engulfingf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Bullish Engulfing' , 'number':num, 'signals':signal}
...
def bullish_haramif(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Bullish Harami' , 'number':num, 'signals':signal}
...
def rising_sunf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Rising Sun' , 'number':num, 'signals':signal}
...
def morning_starf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Morning Star' , 'number':num, 'signals':signal}
...
def three_white_solidersf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Three White Soliders' , 'number':num, 'signals':signal}
...
def inverted_hammerf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Inverted Hammer' , 'number':num, 'signals':signal}
...
def gravestone_dojif(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Gravestone Doji' , 'number':num, 'signals':signal}
...
def black_marubozuf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Black Marubozu' , 'number':num, 'signals':signal}
...
def bearish_engulfingf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Bearish Engulfing' , 'number':num, 'signals':signal}
...
def bearish_haramif(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Bearish Harami' , 'number':num, 'signals':signal}
...
def dark_cloudf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Dark Cloud' , 'number':num, 'signals':signal}
...
def evening_starf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Evening Star' , 'number':num, 'signals':signal}
...
def three_black_crowsf(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Three Black Crows' , 'number':num, 'signals':signal}
...
def dojif(request):
    ...
    signal = "Please select index by default result shows Nifty 500 stocks"
    zipp = zip(stocks,opens,high,low,close)
    dictt = {'zips': zipp ,'candle' : 'Doji' , 'number':num, 'signals':signal}
