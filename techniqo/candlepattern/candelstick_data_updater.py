...
indexs = ['midcap_50.xlsx', 'midcap_100.xlsx', 'midcap_150.xlsx', 'nifty_50.xlsx', 'nifty_100.xlsx', 'nifty_200.xlsx',
          'nifty_500.xlsx', 'nifty_next_50.xlsx', 'smallcap_50.xlsx', 'smallcap_250.xlsx']

for a in indexs:
    wb = xl.load_workbook('D:/college/webend/techniqo/bhavcopynew.xlsx')
    ...
    for j in range(2, sheet2.max_row + 1):
        for i in range(2, sheet1.max_row + 1):
            if (sheet1.cell(i, 1).value == sheet2.cell(j, 1).value) and sheet1.cell(i, 2).value == "EQ":
                ...
                sheet2.cell(j, 7).value = (sheet1.cell(i, 6).value - sheet1.cell(i, 8).value) / sheet1.cell(i,
                                                                                                            8).value * 100

    wb.save('D:/college/webend/techniqo/bhavcopynew.xlsx')
    wb2.save(a)
